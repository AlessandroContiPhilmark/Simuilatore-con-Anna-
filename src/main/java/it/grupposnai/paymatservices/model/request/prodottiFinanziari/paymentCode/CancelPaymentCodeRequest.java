...
@XmlType(name = "CancelPaymentCodeRequest")
public class CancelPaymentCodeRequest {
	...
	public String toString() {
		return "CancelPaymentCodeRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIp=" + userIp + ", firma=" + firma + ", token=" + token + ", idAziendaDistributore=" + idAziendaDistributore
				+ ", idAziendaEsercente=" + idAziendaEsercente + ", cab=" + cab + ", idTerminale=" + idTerminale + ", reserveRequestId=" + reserveRequestId + ", idBrand=" + idBrand + "]";
	}
