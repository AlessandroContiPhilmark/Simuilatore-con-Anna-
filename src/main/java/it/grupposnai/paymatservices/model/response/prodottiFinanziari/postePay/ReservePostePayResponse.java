...
@XmlType(name = "ReservePostePayResponse")
public class ReservePostePayResponse {
	...
	public String toString() {
		return "ReservePostePayResponse [callerId=" + callerId + ", requestId=" + requestId + ", resultCode="
				+ resultCode + ", resultDesc=" + resultDesc + ", idTranPaymat=" + idTranPaymat + ", idTranEsterno="
				+ idTranEsterno + ", dataCompetenza=" + dataCompetenza + "]";
	}
