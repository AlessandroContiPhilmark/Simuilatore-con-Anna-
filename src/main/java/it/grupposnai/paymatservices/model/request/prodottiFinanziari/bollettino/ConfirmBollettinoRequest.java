...
@XmlType(name = "ConfirmBollettinoRequest")
public class ConfirmBollettinoRequest {
	...
	public String toString() {
		return "ConfirmBollettinoRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIp=" + userIp + ", firma=" + firma + ", token=" + token + ", idAziendaDistributore=" + idAziendaDistributore
