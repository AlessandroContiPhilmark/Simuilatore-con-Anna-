...
@XmlType(name = "CancelMavRavRequest")
public class CancelMavRavRequest {
	...
	public String toString() {
		return "CancelMavRavRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIp=" + userIp + ", firma=" + firma + ", token=" + token + ", idAziendaDistributore=" + idAziendaDistributore + ", idAziendaEsercente="
				+ idAziendaEsercente + ", cab=" + cab + ", idTerminale=" + idTerminale + ", reserveRequestId=" + reserveRequestId + ", codiceCredito=" + codiceCredito + "]";
	}
