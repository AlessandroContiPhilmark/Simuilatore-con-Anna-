...
@XmlType(name = "CancelBollettinoResponse")
public class CancelBollettinoResponse {
	...
	public String toString() {
		return "CancelBollettinoResponse [callerId=" + callerId + ", requestId=" + requestId + ", resultCode=" + resultCode + ", resultDesc=" + resultDesc + ", idTranPaymat=" + idTranPaymat + ", idTranEsterno=" + idTranEsterno + "]";
	}
