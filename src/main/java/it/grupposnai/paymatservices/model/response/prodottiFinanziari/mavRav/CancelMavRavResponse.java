...
@XmlType(name = "CancelMavRavResponse")
public class CancelMavRavResponse {
	...
	public String toString() {
		return "CancelMavRavResponse [callerId=" + callerId + ", requestId=" + requestId + ", resultCode=" + resultCode
