...
@XmlType(name = "CancelRicaricaContoRequest")
public class CancelRicaricaContoRequest {
	...
	public String toString() {
		return String.format(
				"CancelRicaricaContoRequest [callerId=%s, requestId=%s, skin=%s, userIp=%s, firma=%s, token=%s, idAziendaDistributore=%s, idAziendaEsercente=%s, reserveRequestId=%s, idTerminale=%s, codiceCredito=%s]",
				callerId, requestId, skin, userIp, firma, token, idAziendaDistributore, idAziendaEsercente,
				reserveRequestId, idTerminale, codiceCredito);
	}
