...
@XmlType(name = "ConfirmAcquistoPinResponse")
public class ConfirmAcquistoPinResponse {
	...
	public String toString() {
		return "ConfirmAcquistoPinResponse [callerId=" + callerId + ", requestId=" + requestId + ", resultCode="
				+ resultCode + ", resultDesc=" + resultDesc + ", seriale=" + seriale + ", pin=" + pin + ", scadenza="
				+ scadenza + ", importo=" + importo + ", idTranPaymat=" + idTranPaymat + ", idTranEsterno="
				+ idTranEsterno + ", ticket=" + ticket + "]";
	}
