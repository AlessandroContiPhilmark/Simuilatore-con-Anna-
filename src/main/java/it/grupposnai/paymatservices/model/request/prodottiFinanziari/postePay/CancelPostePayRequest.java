...
@XmlType(name = "CancelPostePayRequest")
public class CancelPostePayRequest {
	...
	public String toString() {
		return "CancelPostePayRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIp=" + userIp + ", firma=" + firma + ", token=" + token + ", idAziendaDistributore=" + idAziendaDistributore
