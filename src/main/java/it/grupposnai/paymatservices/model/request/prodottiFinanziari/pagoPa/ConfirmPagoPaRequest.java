package it.grupposnai.paymatservices.model.request.prodottiFinanziari.pagoPa;
...
@XmlType(name = "ConfirmPagoPaRequest")
public class ConfirmPagoPaRequest {
	...
	public String toString() {
		return "ConfirmPagoPaRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIp=" + userIp + ", firma=" + firma + ", token=" + token + ", idAziendaDistributore=" + idAziendaDistributore
