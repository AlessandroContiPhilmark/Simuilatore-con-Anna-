...
@XmlType(name = "CancelPagoPaResponse")
public class CancelPagoPaResponse {
	...
	public String toString() {
		return "CancelPagoPaResponse [callerId=" + callerId + ", requestId=" + requestId + ", resultCode=" + resultCode + ", resultDesc=" + resultDesc + ", idTranPaymat=" + idTranPaymat + ", idTranEsterno=" + idTranEsterno + ", dataCompetenza="
				+ dataCompetenza + "]";
	}
