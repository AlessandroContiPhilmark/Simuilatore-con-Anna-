...
@XmlType(name = "InfoCbillGetBillersRequest")
public class InfoCbillGetBillersRequest {
	...
	public String toString() {
		return "InfoCbillGetBillersRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIp=" + userIp + ", firma=" + firma + ", token=" + token
