package it.grupposnai.paymatservices.model.request.prodottiFinanziari.bolloAuto;
...
@XmlType(name = "ReserveBolloAutoRequest")
public class ReserveBolloAutoRequest {
	...
	public String toString() {
		return "ReserveBolloAutoRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIp=" + userIp + ", firma=" + firma + ", token=" + token + ", idAziendaDistributore=" + idAziendaDistributore
				+ ", idAziendaEsercente=" + idAziendaEsercente + ", cab=" + cab + ", idTerminale=" + idTerminale + ", email=" + email + ", telefono=" + telefono + ", codiceCredito=" + codiceCredito + ", persone=" + Arrays.toString(persone)
				+ ", tipoVeicolo=" + tipoVeicolo + ", targaVeicolo=" + targaVeicolo + ", numeroTelaio=" + numeroTelaio + "]";
	}
