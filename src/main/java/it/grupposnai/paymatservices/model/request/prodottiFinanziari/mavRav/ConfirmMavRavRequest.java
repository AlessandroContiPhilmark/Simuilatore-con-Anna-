package it.grupposnai.paymatservices.model.request.prodottiFinanziari.mavRav;
...
@XmlType(name = "ConfirmMavRavRequest")
public class ConfirmMavRavRequest {
	...
	public String toString() {
		return "ConfirmMavRavRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIp=" + userIp + ", firma=" + firma + ", token=" + token
				+ ", idAziendaDistributore=" + idAziendaDistributore + ", idAziendaEsercente=" + idAziendaEsercente + ", cab=" + cab + ", idTerminale=" + idTerminale + ", reserveRequestId="
				+ reserveRequestId + ", codiceCredito=" + codiceCredito + "]";
	}
