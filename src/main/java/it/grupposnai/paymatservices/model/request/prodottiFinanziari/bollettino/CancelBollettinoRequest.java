...
@XmlType(name = "CancelBollettinoRequest")
public class CancelBollettinoRequest {
	...
	public String toString() {
		return "CancelBollettinoRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIp=" + userIp + ", firma=" + firma + ", token=" + token + ", idAziendaDistributore=" + idAziendaDistributore
