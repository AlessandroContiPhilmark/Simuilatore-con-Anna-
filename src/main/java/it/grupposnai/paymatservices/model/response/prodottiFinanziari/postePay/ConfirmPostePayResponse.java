package it.grupposnai.paymatservices.model.response.prodottiFinanziari.postePay;

import javax.xml.bind.annotation.XmlType;

import it.grupposnai.paymatservices.model.response.ricarica.Ticket;

@XmlType(name = "ConfirmPostePayResponse")
public class ConfirmPostePayResponse {
	...
	public String toString() {
		return "ConfirmPostePayResponse [callerId=" + callerId + ", requestId=" + requestId + ", resultCode="
				+ resultCode + ", resultDesc=" + resultDesc + ", idTranPaymat=" + idTranPaymat + ", idTranEsterno="
				+ idTranEsterno + ", dataCompetenza=" + dataCompetenza + ", ticket=" + ticket + "]";
	}
