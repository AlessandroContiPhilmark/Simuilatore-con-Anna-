...
@XmlType(name = "CancelPagoPaRequest")
public class CancelPagoPaRequest {
	...
	public String toString() {
		return "CancelPagoPaRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIp=" + userIp + ", firma=" + firma + ", token=" + token + ", idAziendaDistributore=" + idAziendaDistributore + ", idAziendaEsercente="
