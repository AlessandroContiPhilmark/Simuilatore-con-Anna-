...
@XmlType(name = "CancelBolloAutoRequest")
public class CancelBolloAutoRequest {
	...
	public String toString() {
		return "CancelBolloAutoRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIp=" + userIp + ", firma=" + firma + ", token=" + token + ", idAziendaDistributore=" + idAziendaDistributore
