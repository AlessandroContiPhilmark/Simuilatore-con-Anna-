...
@XmlType(name = "ConfirmRicaricaContoResponse")
public class ConfirmRicaricaContoResponse {
	...
	public String toString() {
		return "ConfirmRicaricaContoResponse [callerId=" + callerId + ", requestId=" + requestId + ", resultCode="
