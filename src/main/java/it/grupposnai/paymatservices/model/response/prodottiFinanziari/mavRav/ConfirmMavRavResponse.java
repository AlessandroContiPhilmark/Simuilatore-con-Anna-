...
@XmlType(name = "ConfirmMavRavResponse")
public class ConfirmMavRavResponse {
	...
	public String toString() {
		return "ConfirmMavRavResponse [callerId=" + callerId + ", requestId=" + requestId + ", resultCode=" + resultCode
				+ ", resultDesc=" + resultDesc + ", idTranPaymat=" + idTranPaymat + ", idTranEsterno=" + idTranEsterno
				+ ", listaTasse=" + Arrays.toString(listaTasse) + ", dataCompetenza=" + dataCompetenza + ", ticket="
				+ ticket + "]";
	}
