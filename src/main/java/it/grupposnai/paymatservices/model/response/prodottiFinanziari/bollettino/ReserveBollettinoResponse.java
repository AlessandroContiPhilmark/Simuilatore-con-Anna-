...
@XmlType(name = "ReserveBollettinoResponse")
public class ReserveBollettinoResponse {
	...
	public String toString() {
		return "ReserveBollettinoResponse [callerId=" + callerId + ", requestId=" + requestId + ", resultCode=" + resultCode + ", resultDesc=" + resultDesc + ", resultDetail=" + resultDetail + ", idTranPaymat=" + idTranPaymat + ", idTranEsterno="
				+ idTranEsterno + ", listaTasse=" + Arrays.toString(listaTasse) + "]";
	}
