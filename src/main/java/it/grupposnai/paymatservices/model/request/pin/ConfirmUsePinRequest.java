...
@XmlType(name = "ConfirmUsePinRequest")
public class ConfirmUsePinRequest {
	...
	public String toString() {
		return "ConfirmUsePinRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin
				...
				+ ", idTerminale=" + idTerminale + ", reserveRequestId=" + reserveRequestId + ", account=" + account
				+ ", pin=" + pin + "]";
	}
