...
@XmlType(name = "CancelBollettinoFrecciaRequest")
public class CancelBollettinoFrecciaRequest {
	...
	public String toString() {
		return "CancelBollettinoFrecciaRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIp=" + userIp + ", firma=" + firma + ", token=" + token + ", idAziendaDistributore=" + idAziendaDistributore
