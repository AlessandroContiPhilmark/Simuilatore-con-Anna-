package it.grupposnai.simulatore.model.request.generali;

import javax.xml.bind.annotation.XmlType;

@XmlType(name = "GetCategorieRequest")
public class GetCategorieRequest {
	...
	public String toString() {
		return "GetCategorieRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIP=" + userIP + ", firma=" + firma + ", token=" + token + ", idAziendaDistributore=" + idAziendaDistributore + ", idAziendaEsercente="
				+ idAziendaEsercente + ", cab=" + cab + ", idTerminale=" + idTerminale + ", var=" + var + "]";
	}
