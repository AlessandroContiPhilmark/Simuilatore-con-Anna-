...
@XmlType(name = "CancelPostePayResponse")
public class CancelPostePayResponse {
	...
	public String toString() {
		return "CancelPostePayResponse [callerId=" + callerId + ", requestId=" + requestId + ", resultCode="
				+ resultCode + ", resultDesc=" + resultDesc + ", idTranPaymat=" + idTranPaymat + ", idTranEsterno="
				+ idTranEsterno + ", dataCancel=" + dataCancel + "]";
	}
