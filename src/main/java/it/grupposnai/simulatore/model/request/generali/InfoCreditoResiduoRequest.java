...
@XmlType(name = "InfoCreditoResiduoRequest")
public class InfoCreditoResiduoRequest {
	...
	public String toString() {
		return "InfoCreditoResiduoRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin
