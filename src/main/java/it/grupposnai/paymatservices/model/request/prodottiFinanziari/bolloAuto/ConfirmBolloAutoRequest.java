...
@XmlType(name = "ConfirmBolloAutoRequest")
public class ConfirmBolloAutoRequest {
	...
	public String toString() {
		return "ConfirmBolloAutoRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIp=" + userIp + ", firma=" + firma + ", token=" + token + ", idAziendaDistributore=" + idAziendaDistributore
				+ ", idAziendaEsercente=" + idAziendaEsercente + ", cab=" + cab + ", idTerminale=" + idTerminale + ", reserveRequestId=" + reserveRequestId + ", codiceCredito=" + codiceCredito + "]";
	}
