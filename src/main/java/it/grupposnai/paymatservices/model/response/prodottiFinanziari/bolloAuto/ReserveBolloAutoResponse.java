...
@XmlType(name = "ReserveBolloAutoResponse")
public class ReserveBolloAutoResponse {
	...
	public String toString() {
		return "ReserveBolloAutoResponse [callerId=" + callerId + ", requestId=" + requestId + ", resultCode=" + resultCode + ", resultDesc=" + resultDesc + ", idTranPaymat=" + idTranPaymat + ", idTranEsterno=" + idTranEsterno + ", dataCompetenza="
				+ dataCompetenza + ", causale=" + causale + ", importo=" + importo + "]";
	}
