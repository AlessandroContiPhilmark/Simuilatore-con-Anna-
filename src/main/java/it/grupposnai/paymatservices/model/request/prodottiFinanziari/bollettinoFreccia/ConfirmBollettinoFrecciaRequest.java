...
@XmlType(name = "ConfirmBollettinoFrecciaRequest")
public class ConfirmBollettinoFrecciaRequest {
	...
	public String toString() {
		return "ConfirmBollettinoFrecciaRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIp=" + userIp + ", firma=" + firma + ", token=" + token + ", idAziendaDistributore=" + idAziendaDistributore
