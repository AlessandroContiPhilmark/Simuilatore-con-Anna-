...
@XmlType(name = "ConfirmPostePayRequest")
public class ConfirmPostePayRequest {
	...
	public String toString() {
		return "ConfirmPostePayRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIp=" + userIp + ", firma=" + firma + ", token=" + token
