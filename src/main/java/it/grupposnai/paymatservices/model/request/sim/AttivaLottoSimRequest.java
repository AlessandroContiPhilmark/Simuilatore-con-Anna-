...
@XmlType(name = "AttivaLottoSimRequest")
public class AttivaLottoSimRequest {
	...
	public String toString() {
		return "AttivaLottoSimRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIp=" + userIp + ", firma=" + firma + ", token=" + token + ", idAziendaDistributore=" + idAziendaDistributore + ", idAziendaEsercente=" + idAziendaEsercente + ", cab=" + cab
				+ ", idTerminale=" + idTerminale + ", provider=" + provider + ", codiceLotto=" + codiceLotto + "]";
	}
