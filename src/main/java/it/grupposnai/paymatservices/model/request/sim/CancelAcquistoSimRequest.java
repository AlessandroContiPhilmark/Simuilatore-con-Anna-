...
@XmlType(name = "CancelAcquistoSimRequest")
public class CancelAcquistoSimRequest {
	...
	public String toString() {
		return "CancelAcquistoSimRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIp=" + userIp + ", firma=" + firma + ", token=" + token + ", idAziendaDistributore=" + idAziendaDistributore + ", idAziendaEsercente=" + idAziendaEsercente + ", cab=" + cab
