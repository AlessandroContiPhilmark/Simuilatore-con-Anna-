...
@XmlType(name = "ConfirmPagoPaResponse")
public class ConfirmPagoPaResponse {
	...
	public String toString() {
		return "ConfirmPagoPaResponse [callerId=" + callerId + ", requestId=" + requestId + ", resultCode=" + resultCode + ", resultDesc=" + resultDesc + ", idTranPaymat=" + idTranPaymat + ", idTranEsterno=" + idTranEsterno + ", dataCompetenza="
				+ dataCompetenza + ", listaTasse=" + Arrays.toString(listaTasse) + ", ticket=" + ticket + "]";
	}
