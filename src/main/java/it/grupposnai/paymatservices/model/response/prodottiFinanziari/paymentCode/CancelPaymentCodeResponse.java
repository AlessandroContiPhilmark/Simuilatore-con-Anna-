...
@XmlType(name = "CancelPaymentCodeResponse")
public class CancelPaymentCodeResponse {
	...
	public String toString() {
		return "CancelPaymentCodeResponse [callerId=" + callerId + ", requestId=" + requestId + ", resultCode=" + resultCode + ", resultDesc=" + resultDesc + ", dataCancel="
				+ dataCancel + "]";
	}
