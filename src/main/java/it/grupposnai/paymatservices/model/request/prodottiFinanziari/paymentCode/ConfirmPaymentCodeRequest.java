...
@XmlType(name = "ConfirmPaymentCodeRequest")
public class ConfirmPaymentCodeRequest {
	...
	public String toString() {
		return "ConfirmPaymentCodeRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin + ", userIp=" + userIp + ", firma=" + firma + ", token=" + token
				+ ", idAziendaDistributore=" + idAziendaDistributore + ", idAziendaEsercente=" + idAziendaEsercente + ", cab=" + cab + ", idTerminale=" + idTerminale
				+ ", reserveRequestId=" + reserveRequestId + ", idBrand=" + idBrand + "]";
	}
