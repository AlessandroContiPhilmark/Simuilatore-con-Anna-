...
@XmlType(name = "ConfirmRicaricaContoRequest")
public class ConfirmRicaricaContoRequest {
	...
	public String toString() {
		return "ConfirmRicaricaContoRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin
				...
				+ ", idTerminale=" + idTerminale + ", reserveRequestId=" + reserveRequestId + ", codiceCredito="
				+ codiceCredito + "]";
	}
