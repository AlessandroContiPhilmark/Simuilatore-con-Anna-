...
@XmlType(name = "ReserveUsePinRequest")
public class ReserveUsePinRequest {
	...
	public String toString() {
		return "ReserveUsePinRequest [callerId=" + callerId + ", requestId=" + requestId + ", skin=" + skin
				...
				+ ", idTerminale=" + idTerminale + ", account=" + account + ", pin=" + pin + "]";
	}
