...
@XmlType(name = "ReserveAcquistoPinResponse")
public class ReserveAcquistoPinResponse {
	...
	public String toString() {
		return "ReserveAcquistoPinResponse [callerId=" + callerId + ", requestId=" + requestId + ", resultCode="
