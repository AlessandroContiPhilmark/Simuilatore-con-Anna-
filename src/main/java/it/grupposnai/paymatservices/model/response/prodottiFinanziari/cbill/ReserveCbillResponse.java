...
@XmlType(name = "ReserveCbillResponse")
public class ReserveCbillResponse {
	...
	public String toString() {
		return "ReserveCbillResponse [callerId=" + callerId + ", requestId=" + requestId + ", resultCode=" + resultCode + ", resultDesc=" + resultDesc + ", idTranPaymat="
				+ idTranPaymat + ", idTranEsterno=" + idTranEsterno + ", dataCompetenza=" + dataCompetenza + ", listaTasse=" + Arrays.toString(listaTasse) + "]";
	}
}
