...
@XmlType(name = "CancelBolloAutoResponse")
public class CancelBolloAutoResponse {
	...
	public String toString() {
		return "CancelBolloAutoResponse [callerId=" + callerId + ", requestId=" + requestId + ", resultCode=" + resultCode + ", resultDesc=" + resultDesc + ", idTranPaymat=" + idTranPaymat + ", idTranEsterno=" + idTranEsterno + ", dataCancel="
				+ dataCancel + "]";
	}
