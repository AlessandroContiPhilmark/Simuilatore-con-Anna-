...
@XmlType(name = "ConfirmBollettinoResponse")
public class ConfirmBollettinoResponse {
	...
	public String toString() {
		return "ConfirmBollettinoResponse [callerId=" + callerId + ", requestId=" + requestId + ", resultCode=" + resultCode + ", resultDesc=" + resultDesc + ", idTranPaymat=" + idTranPaymat + ", idTranEsterno=" + idTranEsterno + ", listaTasse="
				+ Arrays.toString(listaTasse) + ", ticket=" + ticket + "]";
	}
